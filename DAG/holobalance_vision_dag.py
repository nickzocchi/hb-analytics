...
with DAG(
    ...
    updater = SparkSubmitOperator(
        application="hdfs://namenode:9000/scripts/holobalance_vision.py",						# We have a folder in the HDFS file system called scripts so we can upload files there
        task_id="updater",

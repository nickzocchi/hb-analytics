...
with DAG(
    dag_id='holobalance_dizziness_dag',
    ...
    updater = SparkSubmitOperator(
        application="hdfs://namenode:9000/scripts/holobalance_dizziness.py",						# We have a folder in the HDFS file system called scripts so we can upload files there
        task_id="updater",
